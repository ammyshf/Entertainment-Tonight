...
//database connection
$con=mysqli_connect('localhost','id15483555_bingeflix','ProjectDatabase1!','id15483555_proj_register');
$db=mysqli_select_db($con,"id15483555_proj_register");
